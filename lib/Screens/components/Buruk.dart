...
import 'package:seratustokohalkitab/Screens/components/DetailBuruk.dart';

import 'package:seratustokohalkitab/others/DataTokoh.dart';
import 'package:seratustokohalkitab/others/Services.dart';

class Buruk extends StatefulWidget {
  Buruk() : super();

  @override
  _BurukState createState() => _BurukState();
}

class _BurukState extends State<Buruk> {
                    ...
                    return GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) =>DetailBuruk(args: tempList[index]),
                            ),
                          );
                        });
                  }))
